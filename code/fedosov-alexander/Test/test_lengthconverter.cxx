...
TEST_F(lengthconverterTest, creatinon_test1) {
    Length::Type wrong  = static_cast<Length::Type>(15);
    EXPECT_THROW(Length(wrong, 100000), std::string);
}

TEST_F(lengthconverterTest, creatinon_test2) {
    Length len = Length(Length::Type::TYPE_METER, 100000);
    EXPECT_EQ(Length::Type::TYPE_METER, len.getType());
    EXPECT_NEAR(100000.0, len.getLength(), 0.000001);
}

TEST_F(lengthconverterTest, creatinon_test4) {
    Length len = Length(Length::Type::TYPE_INCH, -DBL_MAX+100);
    EXPECT_EQ(Length::Type::TYPE_INCH, len.getType());
    EXPECT_NEAR(0.0, len.getLength(), 0.000001);
}

TEST_F(lengthconverterTest, creatinon_test5) {
    Length len = Length(Length::Type::TYPE_YARD, -DBL_MAX+100);
    EXPECT_EQ(Length::Type::TYPE_YARD, len.getType());
    EXPECT_NEAR(0.0, len.getLength(), 0.000001);
}

TEST_F(lengthconverterTest, creatinon_test6) {
    Length len = Length(Length::Type::TYPE_FOOT, -DBL_MAX+100);
    EXPECT_EQ(Length::Type::TYPE_FOOT, len.getType());
    EXPECT_NEAR(0.0, len.getLength(), 0.000001);
}

TEST_F(lengthconverterTest, conversion_test1) {
    Length len = Length(Length::Type::TYPE_FOOT, -DBL_MAX+100);
    len.setType(Length::Type::TYPE_METER);
    EXPECT_EQ(Length::Type::TYPE_METER, len.getType());
    EXPECT_NEAR(0.0, len.getLength(), 0.000001);
}

TEST_F(lengthconverterTest, conversion_test2) {
    Length len = Length(Length::Type::TYPE_FOOT, 100.0);
    len.setType(Length::Type::TYPE_METER);
    EXPECT_EQ(Length::Type::TYPE_METER, len.getType());
...
TEST_F(lengthconverterTest, conversion_test3) {
    Length len = Length(Length::Type::TYPE_FOOT, 100.0);
    len.setType(Length::Type::TYPE_FOOT);
    EXPECT_EQ(Length::Type::TYPE_FOOT, len.getType());
...
TEST_F(lengthconverterTest, conversion_test4) {
    Length len = Length(Length::Type::TYPE_FOOT, 100.0);
    len.setType(Length::Type::TYPE_INCH);
    EXPECT_EQ(Length::Type::TYPE_INCH, len.getType());
...
TEST_F(lengthconverterTest, conversion_test12) {
    Length len = Length(Length::Type::TYPE_MILE, 100.0);
    len.setType(Length::Type::TYPE_FOOT);
    EXPECT_EQ(Length::Type::TYPE_FOOT, len.getType());
...
TEST_F(lengthconverterTest, conversion_test17) {
    Length len = Length(Length::Type::TYPE_YARD, 100.0);
    len.setType(Length::Type::TYPE_FOOT);
    EXPECT_EQ(Length::Type::TYPE_FOOT, len.getType());
...
TEST_F(lengthconverterTest, conversion_test22) {
    Length len = Length(Length::Type::TYPE_INCH, 100.0);
    len.setType(Length::Type::TYPE_FOOT);
    EXPECT_EQ(Length::Type::TYPE_FOOT, len.getType());
...
TEST_F(lengthconverterTest, conversion_test27) {
    Length len = Length(Length::Type::TYPE_INCH, 100.0);
    Length* len1;
    len1 = len.convert(Length::Type::TYPE_FOOT);
    EXPECT_EQ(Length::Type::TYPE_FOOT, len1->getType());
...
TEST_F(lengthconverterTest, conversion_test28) {
    Length len = Length(Length::Type::TYPE_INCH, 100.0);
    Length* len1;
    len1 = len.convert(Length::Type::TYPE_MILE);
    EXPECT_EQ(Length::Type::TYPE_MILE, len1->getType());
...
TEST_F(lengthconverterTest, conversion_test29) {
    Length len = Length(Length::Type::TYPE_INCH, 100.0);
    Length* len1;
    len1 = len.convert(Length::Type::TYPE_INCH);
    EXPECT_EQ(Length::Type::TYPE_INCH, len1->getType());
    EXPECT_NEAR(100.0, len1->getLength(), 0.001);
}
TEST_F(lengthconverterTest, conversion_test30) {
    Length len = Length(Length::Type::TYPE_INCH, 100.0);
    Length* len1;
    len1 = len.convert(Length::Type::TYPE_YARD);
    EXPECT_EQ(Length::Type::TYPE_YARD, len1->getType());
    EXPECT_NEAR(2.78, len1->getLength(), 0.001);
}
TEST_F(lengthconverterTest, conversion_test31) {
    Length len = Length(Length::Type::TYPE_INCH, 100.0);
    Length* len1;
    len1 = len.convert(Length::Type::TYPE_METER);
    EXPECT_EQ(Length::Type::TYPE_METER, len1->getType());
